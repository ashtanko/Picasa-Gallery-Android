...
object Config {
  ...
  private const val PICASA_BASE_URL = "https://picasaweb.google.com/data"
  ...
  internal fun configureAlbumsPath(
    userId: String,
    albumId: String
  ) = format("user/%s/alubumid/%s", userId, albumId)
}
