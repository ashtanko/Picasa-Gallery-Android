...
public class FastDateParser implements DateParser, Serializable {
   ...
   */
  private static StringBuilder escapeRegex(final StringBuilder regex, final String value,
   ...
   */
  private static Map<String, Integer> getDisplayNames(final int field,
      final Calendar definingCalendar, final Locale locale) {
  ...
  private Strategy getStrategy(final String formatField, final Calendar definingCalendar) {
    switch (formatField.charAt(0)) {
      ...
      case 'M':
        return formatField.length() >= 3 ? getLocaleSpecificStrategy(Calendar.MONTH,
