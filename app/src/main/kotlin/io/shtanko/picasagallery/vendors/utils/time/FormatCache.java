...
abstract class FormatCache<F extends Format> {
  ...
  private F getDateTimeInstance(final Integer dateStyle, final Integer timeStyle,
  ...
  F getDateTimeInstance(final int dateStyle, final int timeStyle, final TimeZone timeZone,
      Locale locale) {
