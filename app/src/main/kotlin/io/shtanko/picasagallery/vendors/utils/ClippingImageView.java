    ...
    if (bmp != null) {
      ...
      if (needRadius) {
        ...
        if (Math.abs(scaleW - scaleH) > 0.00001f) {
          ...
          AndroidUtils.INSTANCE.setRectToRect(shaderMatrix, bitmapRect, roundRect, orientation,
        ...
        canvas.clipRect(clipLeft / scaleY, clipTop / scaleY, getWidth() - clipRight / scaleY,
